...
B2G_URL_BASE = https://ftp.mozilla.org/pub/mozilla.org/b2g/nightly/2014-03-12-00-40-01-mozilla-b2g28_v1_3/
...
ifeq (win32, $(B2G_PLATFORM))
  ...
  B2G_URL ?= $(B2G_URL_BASE)b2g-28.0.multi.win32.zip
  B2G_BIN_DIR = b2g
else
ifeq (mac64, $(B2G_PLATFORM))
  B2G_URL ?= $(B2G_URL_BASE)b2g-28.0.multi.mac64.dmg
...
ifeq (linux, $(B2G_PLATFORM))
  B2G_URL ?= $(B2G_URL_BASE)b2g-28.0.multi.linux-i686.tar.bz2
  B2G_BIN_DIR = b2g
endif
endif
endif
